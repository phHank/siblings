"""
Django settings for siblings project.
...
SECRET_KEY = '956t#)uj6k_0(e9m&m$qgqo#qj^0j=t)9&uti8=r_l%i+)*=e*'
...
INSTALLED_APPS = [
    ...
    'sib_apps.checkout.apps.CheckoutConfig',
...
WSGI_APPLICATION = 'siblings.wsgi.application'
